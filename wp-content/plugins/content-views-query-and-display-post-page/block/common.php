...
class ContentViews_Block_Common {
	...
	static function upgrade_for_block( $block, $block_demo = '' ) {
		...
		$output	 = "<div style='text-align: center; background: #f9f9f9; padding: 10px;'>$text <img src='$img' style='max-width: 450px; margin-bottom: 20px;' /> <p><a href='$demo_url' target='_blank'>See Demo</a></p></div>";
		return $output;
	}
	...
	static function pro_sortby() {
		return array(
			...
			'custom_field_sort'	 => __( 'Custom Field', 'content-views-query-and-display-post-page' ),
		);
	}
	...
	static function fields_sortable() {
		return [
			...
			'showMeta'		 => __( 'Bottom Meta', 'content-views-query-and-display-post-page' ) ] + self::pro_fields_sortable();
	}
